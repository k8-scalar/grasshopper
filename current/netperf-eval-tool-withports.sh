#! /bin/bash
echo ==============================
rm /home/ubuntu/current_svc_port_cidr/src_dir/*
rm /home/ubuntu/current_svc_port_cidr/data/*
cd expt/
...
kubectl create -f host-network-policy-withports.yaml
kubectl create -f client-network-policy-withports.yaml
